...
public class FilmFactory  implements IFactoryFilm {
    ...
    @Override
    public Film getInstance(String title, List<Genre> genres, String original_language, String director, String writer, Date release_date, Integer runtime, String distributor, String production_co, Double average_rating_critic, Double average_rating_audience) {
